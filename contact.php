...
$intro_body = getPageSection('contact', 'intro_body', 'Whether you are planning a stay, coordinating an event, or have a question before arrival, our team is here to help.');
$address_html = getPageSection('contact', 'address_html', "123 Hospitality Avenue<br/>\nCity Center,<br/>\nCountry");
$directions_href = getPageSection('contact', 'directions_href', '#');
$concierge_phone = getPageSection('contact', 'concierge_phone', cms_default_setting('footer_phone'));
$inquiries_email = getPageSection('contact', 'inquiries_email', cms_default_setting('contact_email'));
    ...
    <div class="md:col-span-5 flex flex-col md:pt-8">
      ...
      <div class="mt-8 grid grid-cols-1 gap-4 max-w-md">
        ...
        <a class="flex items-center justify-between gap-4 bg-primary text-white rounded-lg px-6 py-5 shadow-lg shadow-primary/25 hover:bg-primary-light transition-all"
           href="<?= e(site_href((string)$directions_href)) ?>">
          <div class="flex items-center gap-4 min-w-0">
