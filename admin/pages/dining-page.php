...
<form id="diningPageForm">
  <div class="card"><div class="card-header"><h2>Meta</h2></div><div style="padding:20px;">
    <div class="form-group">
      ...
      <input type="text" id="page_title" name="page_title" value="<?= sanitize($sections['page_title'] ?? 'Dining Experience') ?>">
    </div>
  </div></div>
  ...
  <div class="card"><div class="card-header"><h2>Hero</h2></div><div style="padding:20px;">
    <div class="form-group">
      ...
      <input type="text" id="hero_kicker" name="hero_kicker" value="<?= sanitize($sections['hero_kicker'] ?? 'Dining') ?>">
    </div>
    <div class="form-group">
      <label for="hero_title_html">Title (HTML)</label>
      <textarea id="hero_title_html" name="hero_title_html" rows="3"><?= htmlspecialchars($sections['hero_title_html'] ?? 'Lorem Ipsum <br/><i class="font-light opacity-90">Dolor Sit</i>', ENT_QUOTES, 'UTF-8') ?></textarea>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" id="hero_hours" name="hero_hours" value="<?= sanitize($sections['hero_hours'] ?? 'Open Daily: 00:00 - 00:00') ?>">
    </div>
    <div class="form-group">
  ...
  <div class="card"><div class="card-header"><h2>Chef / intro</h2></div><div style="padding:20px;">
    <div class="form-group">
      ...
      <input type="text" id="intro_vertical" name="intro_vertical" value="<?= sanitize($sections['intro_vertical'] ?? 'Lorem Menus') ?>">
    </div>
    <div class="form-group">
      <label for="chef_title_html">Section title (HTML)</label>
      <textarea id="chef_title_html" name="chef_title_html" rows="2"><?= htmlspecialchars($sections['chef_title_html'] ?? 'Lorem <br/> <span class="text-primary italic">Ipsum</span>', ENT_QUOTES, 'UTF-8') ?></textarea>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" id="chef_signature" name="chef_signature" value="<?= sanitize($sections['chef_signature'] ?? 'Lorem Ipsum') ?>">
    </div>
    <div class="form-row">
      <div class="form-group">
  ...
  <div class="card"><div class="card-header"><h2>Visual narrative strip</h2></div><div style="padding:20px;">
    <div class="form-row">
      <div class="form-group">
        ...
        <input type="text" id="visual_title" name="visual_title" value="<?= sanitize($sections['visual_title'] ?? 'Lorem Gallery') ?>">
      </div>
      <div class="form-group">
  ...
  <div class="card"><div class="card-header"><h2>Menu block</h2></div><div style="padding:20px;">
    <div class="form-group">
      ...
      <input type="text" id="menu_kicker" name="menu_kicker" value="<?= sanitize($sections['menu_kicker'] ?? 'Lorem Menu') ?>">
    </div>
    <div class="form-group">
      <label for="menu_heading">Heading</label>
      <input type="text" id="menu_heading" name="menu_heading" value="<?= sanitize($sections['menu_heading'] ?? 'Lorem Ipsum') ?>">
    </div>
    <div class="form-group">
      <label for="menu_quote">Quote line</label>
      <input type="text" id="menu_quote" name="menu_quote" value="<?= sanitize($sections['menu_quote'] ?? '"Lorem ipsum dolor sit amet."') ?>">
    </div>
    <div class="form-group">
      <label for="menu_iframe_url">Menu iframe URL</label>
      <input type="text" id="menu_iframe_url" name="menu_iframe_url" value="<?= sanitize($sections['menu_iframe_url'] ?? '') ?>">
  ...
  <div class="card"><div class="card-header"><h2>Reservation CTA</h2></div><div style="padding:20px;">
    ...
    <div class="form-group">
      ...
      <input type="text" id="cta_title" name="cta_title" value="<?= sanitize($sections['cta_title'] ?? 'Lorem Reservation') ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input type="text" id="cta_btn1" name="cta_btn1" value="<?= sanitize($sections['cta_btn1'] ?? 'Contact Us') ?>">
      </div>
      <div class="form-group">
