...
<form id="aboutPageForm">
  <div class="card"><div class="card-header"><h2>Meta & hero</h2></div><div style="padding:20px;">
    <div class="form-group">
      ...
      <input type="text" id="page_title" name="page_title" value="<?= sanitize($sections['page_title'] ?? 'About Our Hotel') ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea id="hero_title_html" name="hero_title_html" rows="3"><?= htmlspecialchars($sections['hero_title_html'] ?? 'A Story of <br/><span class="font-bold italic text-primary/90 site-hero-accent-text">Hospitality</span>', ENT_QUOTES, 'UTF-8') ?></textarea>
    </div>
    <div class="form-group">
  ...
  <div class="card"><div class="card-header"><h2>Story block</h2></div><div style="padding:20px;">
    <div class="form-group">
      ...
      <textarea id="story_title_html" name="story_title_html" rows="2"><?= htmlspecialchars($sections['story_title_html'] ?? 'Defining a <br/><span class="font-semibold text-primary">Memorable Stay</span>', ENT_QUOTES, 'UTF-8') ?></textarea>
    </div>
  ...
  <div class="card"><div class="card-header"><h2>Leadership intro</h2></div><div style="padding:20px;">
    ...
    <div class="form-group"><label for="team_heading">Heading</label><input type="text" id="team_heading" name="team_heading" value="<?= sanitize($sections['team_heading'] ?? 'Lorem Ipsum') ?>"></div>
    <div class="form-group"><textarea name="team_intro" id="team_intro" rows="2"><?= sanitize($sections['team_intro'] ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.') ?></textarea></div>
  </div></div>
  ...
  <div class="card"><div class="card-header"><h2>Parallax & CTA</h2></div><div style="padding:20px;">
    ...
    <div class="form-group"><label for="parallax_quote">Parallax quote</label><input type="text" id="parallax_quote" name="parallax_quote" value="<?= sanitize($sections['parallax_quote'] ?? '"Lorem ipsum dolor sit amet."') ?>"></div>
    <div class="form-group"><label for="cta_title">CTA title</label><input type="text" id="cta_title" name="cta_title" value="<?= sanitize($sections['cta_title'] ?? 'Lorem Ipsum Dolor') ?>"></div>
    <div class="form-group"><textarea name="cta_body" id="cta_body" rows="2"><?= sanitize($sections['cta_body'] ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.') ?></textarea></div>
    <div class="form-row">
      <div class="form-group"><label for="cta_btn1">Button 1</label><input type="text" id="cta_btn1" name="cta_btn1" value="<?= sanitize($sections['cta_btn1'] ?? 'Explore Rooms') ?>"></div>
