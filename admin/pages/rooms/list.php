        ...
        <?php foreach ($rooms as $r): ?>
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-sm btn-outline" target="_blank" href="<?= htmlspecialchars(site_absolute_href(site_url('room-details', ['slug' => (string)$r['slug']])), ENT_QUOTES, 'UTF-8') ?>">View</a>
              <?php endif; ?>
