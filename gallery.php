...
$pageTitle = getPageSection('gallery', 'page_title', 'Gallery');
$hero_kicker = getPageSection('gallery', 'hero_kicker', 'Lorem Ipsum');
$hero_title_html = getPageSection('gallery', 'hero_title_html', 'VISUAL <span class="font-bold italic text-primary">LOREM</span>');
$hero_subtitle = getPageSection('gallery', 'hero_subtitle', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');
$hero_bg = getPageSection('gallery', 'hero_bg', $heroPlaceholder);
